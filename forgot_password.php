...
<body class="justify-content-center align-items-center bg-light" style="font-family: 'Poppins', sans-serif;">
  <div class="container mt-5 py-4">
    ...
    <div class="card py-5 mx-auto shadow border-0" style="max-width: 600px;">
      <div class="card-body">
        <h2 class="text-center py-1">FORGOT PASSWORD</h2>
        <p class="text-center">Enter your verified email address and contact number.</p>

        <form action="send_otp.php" method="POST">

          <input type="email" name="email" class="form-control mb-3" placeholder="Email" required>

          <input type="text" name="contact_number" class="form-control mb-3" placeholder="+639123456789" required>
