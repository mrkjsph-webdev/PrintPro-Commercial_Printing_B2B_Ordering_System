...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2026 at 03:24 AM
...
(1, 1, 'A0 (33.11 x 46.81 in)', '120', 'Cast-coated', 5, 785.00),
(2, 2, 'A4 (8.27 x 11.69 in)', '100', 'Matte Finish', 5, 215.00);
...
(1, 1, 'uploaded_files/img_front_6a070c362e22d5.04502562.png', 'uploaded_files/img_back_6a070c362e91b5.65125764.png', '2026-05-15 20:06:14'),
(2, 1, 'uploaded_files/img_front_6a07c6cec43441.50459544.png', 'uploaded_files/img_back_6a07c6cec49a21.98676240.png', '2026-05-16 09:22:22');
...
(1, 1, '2026-05-15 20:06:21', 'pending', 785.00, 'unpaid'),
(2, 1, '2026-05-16 09:22:36', 'pending', 950.00, 'unpaid');
...
INSERT INTO `order_check_out` (`checkout_id`, `order_id`, `payment_method`, `checkout_date`) VALUES
(1, 1, 'credit card', '2026-05-15 20:06:21'),
(2, 2, 'credit card', '2026-05-16 09:22:36');
...
INSERT INTO `order_details` (`order_detail_id`, `order_id`, `cart_item_id`, `quantity`, `subtotal`, `total_price`) VALUES
(1, 1, 1, 1, 785.00, 785.00),
(2, 2, 2, 2, 1000.00, 950.00),
(3, 2, 1, 2, 1000.00, 950.00);
...
(1, 1, 1, 785.00, 0.00, 785.00),
(2, 2, 2, 1000.00, 50.00, 950.00);
...
INSERT INTO `receipt` (`receipt_id`, `order_id`, `receipt_number`, `payment_date`, `amount_paid`, `payment_status`) VALUES
(1, 1, 'RCP-20260515-61275', '2026-05-15', 785.00, 'paid');
...
(1, 1, '2026-05-15 20:06:14', '2026-05-16 09:22:22', 'active');
...
(1, 1, 1, 1, 785.00, '2026-05-15 20:06:14', 1),
(2, 1, 2, 2, 215.00, '2026-05-16 09:22:22', 1);
