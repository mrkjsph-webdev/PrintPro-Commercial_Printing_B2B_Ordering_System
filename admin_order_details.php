...
<body>
    ...
    <div class="main">
        ...
        <div class="card-box mb-4">
            <div class="row">
                ...
                <div class="col-md-5">
                    <button class="btn btn-dark w-100 mb-3" onclick="printImagesOnly()">
                        PRINT IMAGES ONLY
                    </button>
    ...
    <?php if(!empty($item['image1'])): ?>
        <img src="<?= e($item['image1']) ?>"
             class="img-fluid rounded order-img-print mb-2">
    <?php endif; ?>

    <?php if(!empty($item['image2'])): ?>
        <img src="<?= e($item['image2']) ?>"
             class="img-fluid rounded order-img-print">
    <?php endif; ?>
...
function printImagesOnly() {

    let imagesHTML = "";

    document.querySelectorAll(".order-img-print").forEach(img => {
