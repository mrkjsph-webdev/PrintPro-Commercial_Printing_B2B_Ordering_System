...
<body>
    ...
    <div class="sidebar">
        <div class="logo">
            <img src="image_resources/logo.png" width="35" alt="Logo"> PrintPro
        </div>
        ...
        <nav class="nav flex-column">
            ...
            <a href="admin_nalytics.php" class="nav-link">
    ...
    <script>
        ...
        const filterUsers = () => {
            ...
            const filterValue = occupationFilter.value.toLowerCase();
