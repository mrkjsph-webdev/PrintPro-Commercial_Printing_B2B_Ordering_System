...
<head>
    ...
    <title>Order History - PrintPro</title>
...
<body>
    ...
    <main>
        ...
        <div class="px-4 px-md-5 mt-4">
            <h2 class="text-primary fw-bold" style="color: #0088FF !important; font-size: 1.75rem;">Order History</h2>
        </div>
            ...
            <div class="container-box p-4 p-md-5" style="border: 1px solid black;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-5">
                            <select class="form-select border-2 search-input" id="productFilter">
                                ...
                                <option value="Postcards">Completed</option>
                                <option value="Posters">Cancelled</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="scroll-area">
                    <div class="d-flex flex-column gap-3">
                        <div class="order-card p-3 d-flex gap-3 align-items-center flex-wrap flex-md-nowrap">
                            <img src="image_resources/flyers/flyers.png" class="order-img mx-auto mx-md-0">
                            <div class="flex-grow-1">
                                <h5 class="fw-semibold mb-1">Flyers</h5>
                                <p class="small text-secondary mb-0">
                                    Body text for whatever you'd like to say. Add main takeaway points...
                                </p>
                            </div>
                            <div class="text-md-end text-center mt-2 mt-md-0">
                                <div class="status-Completed mb-2">Completed</div>
                                <button class="btn-outline" onclick="window.location.href='order_details.html'">View Order</button>
                            </div>
                        </div>

    
                        <div class="order-card p-3 d-flex gap-3 align-items-center flex-wrap flex-md-nowrap">
                            <img src="image_resources/postcards.webp" class="order-img mx-auto mx-md-0">
                            <div class="flex-grow-1">
                                <h5 class="fw-semibold mb-1">Postcards</h5>
                                <p class="small text-secondary mb-0">
                                    Body text for whatever you'd like to say. Add main takeaway points...
                                </p>
                            </div>
                            <div class="text-md-end text-center mt-2 mt-md-0">
                                <div class="status-Cancelled mb-2">Cancelled</div>
                                <button class="btn-outline" onclick="window.location.href='order_details.html'">View Order</button>
                            </div>
                        </div>
                        ...
                        <div class="order-card p-3 d-flex gap-3 align-items-center flex-wrap flex-md-nowrap">
                            <img src="image_resources/businesscards.webp"
                                class="order-img mx-auto mx-md-0">
                            <div class="flex-grow-1">
                                <h5 class="fw-semibold mb-1">Business Cards</h5>
                                <p class="small text-secondary mb-0">
                                    Body text for whatever you'd like to say. Add main takeaway points...
                                </p>
                            </div>
                        ...
                        <div class="order-card p-3 d-flex gap-3 align-items-center flex-wrap flex-md-nowrap">
                            <img src="image_resources/posters.png" class="order-img mx-auto mx-md-0">
                            <div class="flex-grow-1">
                                <h5 class="fw-semibold mb-1">Posters</h5>
                                <p class="small text-secondary mb-0">
                                    Body text for whatever you'd like to say. Add main takeaway points...
                                </p>
                            </div>
                        ...
                        <div class="order-card p-3 d-flex gap-3 align-items-center flex-wrap flex-md-nowrap">
                            <img src="image_resources/brochure.avif" class="order-img mx-auto mx-md-0">
                            <div class="flex-grow-1">
                                <h5 class="fw-semibold mb-1">Brochure</h5>
                                <p class="small text-secondary mb-0">
                                    Body text for whatever you'd like to say. Add main takeaway points...
                                </p>
                            </div>
